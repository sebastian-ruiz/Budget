...
/**
 * Created by Sebastian on 14/12/14.
 */
public class AnOverviewFragment extends Fragment implements View.OnClickListener {
    //The fragment argument representing the item ID that this fragment represents.
    public static final String ARG_ITEM_ID = "AnOverviewFragment_id";
